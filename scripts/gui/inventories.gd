...
func _process(delta: float) -> void:
	...
	if GameManager.inventory and (GameManager.gadget == null or GameManager.gadget.gadget_stats != teleporter or (GameManager.cursor != null and GameManager.cursor.slot.item != null))
